                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="profile-img">
                            <img src="<?php echo URL . 'assets/imagens/users/' . $_SESSION['usuario_id'] . '/' . $_SESSION['usuario_imagem']; ?>" alt="">
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active show" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true">Timeline</a>
                                </li>
                            </ul>
                        </div>
                    </div>
